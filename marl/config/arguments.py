...
def get_args():
    ...
    parser.add_argument('--train-stage', choices=['joint', 'low'], default='joint',
                        help='joint: original hierarchical training; low: train only the low-level goal-conditioned policy')
